...
@error('nis') is-invalid @enderror"
                                id="exampleInputNis" placeholder="NIS/NIP/NUPTK" name="nis"
                                value="{{ $user->nis ?? old('nis') }}">
                            @error('nis')
...
@error('password') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('level') isinvalid @enderror" id="exampleInputlevel"
                                ...
                                <option value="guru" @if ($user->level == 'guru' || old('level') == 'guru') selected @endif>Guru</option>
                                <option value="kepsek" @if ($user->level == 'kepsek' || old('level') == 'kepsek') selected @endif>Kepala
                                    Sekolah</option>
                                <option value="siswa" @if ($user->level == 'siswa' || old('level') == 'siswa') selected @endif>Siswa</option>
                            </select>
                            @error('level')
                                <span class="textdanger">{{ $message }}</span>
                            @enderror
